...
// This just shows the initial Dashboard that shows how many finished and unfinished tasks we have
// We pull the data using redux and display it here
const Dashboard = () => {
				...
				<div className='dashboard__right'>
					<div className='dashboard__rightContent'>
						...
						<div className='taskcount'>
							<div className='todo box'>Not Done - {pendingTask.length}</div>
