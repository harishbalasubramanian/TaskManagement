...
// This just has all of the possible states for our tasks and acts as the middle ground between backend and frontend
// Manages all task states and helps to provide data for the frontend to display tasks
